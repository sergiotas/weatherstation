...
byte seconds_avg; //Keeps track of the "wind speed/dir avg" over last 2 minutes array of data
...
byte windspdavg[SendDataEach]; //120 bytes to keep track of 2 minute average

int winddiravg[SendDataEach]; //120 ints to keep track of 2 minute average
...
float windspdmph_avg = 0; // [mph 2 minute average wind speed mph]
int winddir_avg = 0; // [0-360 2 minute average wind direction]
...
//        if(++seconds_avg > WIND_DIR_AVG_SIZE-1) seconds_avg = 0;
        if(++seconds_avg > SendDataEach-1) seconds_avg = 0;
        ...
        windspdavg[seconds_avg] = (int)currentSpeed;
        winddiravg[seconds_avg] = currentDirection;
...
//    winddir_avg = sum / WIND_DIR_AVG_SIZE;
    winddir_avg = sum / SendDataEach;
