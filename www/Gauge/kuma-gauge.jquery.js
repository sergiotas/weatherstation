    ...
    kumaGauge.prototype = {
        ...
        draw : function() {
            ...
            if (_this.config.label.display) {
                ...
                // Draw the center label // sergiotas
                _this.gauge.centerLabel = _this.gauge.text(_this.config.width/2,
                                    _this.config.centerY + 10, _this.config.label.center);
                _this.gauge.centerLabel.attr({
                    'fill' : _this.config.title.fontColor,
                    'fill-opacity' : 0,
                    'font-size' : _this.config.label.fontSize+2,
                    'font-family' : _this.config.label.fontFamily,
                    'font-weight' : _this.config.label.fontWeight
                });
                _this.gauge.centerLabel.node.setAttribute('class', 'gauge__label--center');
            ...
            setTimeout(function() {
                ...
                if (_this.config.label.display) {
                    ...
                    _this.gauge.centerLabel.attr({ // sergiotas
                        'y' : _this.config.centerY + (_this.gauge.centerLabel.getBBox().height + 10 ),
                        'fill-opacity' : 1,
                    });
